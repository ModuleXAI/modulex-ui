...
function createModelId(model: Model) {
...
export function ModelDropdown({ models }: { models: Model[] }) {
  ...
  const handleModelSelect = (id: string) => {
    ...
    if (selectedModel) setCookie('selectedModel', JSON.stringify(selectedModel))
    else setCookie('selectedModel', '')
    setOpen(false)
  }
