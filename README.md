...
![capture](/public/app_prewview_ss.png)
![capture](/public/app_prewview_ss2.png)
...
📝 Explore AI-generated documentation on [DeepWiki](https://docs.modulex.dev/modulex-ui)
...
```bash
git clone git@github.com:ModuleXAI/modulex-ui.git
```
...
Host your own live version of ModuleX UI with Vercel, Cloudflare Pages, or Docker.

### Vercel

[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2FModuleXAI%2Fmodulex-ui&env=OPENAI_API_KEY,TAVILY_API_KEY,UPSTASH_REDIS_REST_URL,UPSTASH_REDIS_REST_TOKEN)
...
```bash
docker pull ghcr.io/modulex/modulex-ui:latest
```
...
services:
  modulex-ui:
    image: ghcr.io/modulex/modulex-ui:latest
    env_file: .env.local
    ports:
      - '3000:3000'
    volumes:
...
If you want to use ModuleX-UI as a search engine in your browser, follow these steps:
...
5. Fill in the fields as follows:
   - **Search engine**: ModuleX-UI
   - **Shortcut**: ModuleX-UI
6. Click "Add" to save the new search engine.
7. Find "ModuleX-UI" in the list of site search, click on the three dots next to it, and select "Make default".
